//
//  UNLRSSVidaUniversitariaViewController.m
//  UNLRSS
//
...
#import "UNLRSSVidaUniversitariaViewController.h"
#import "AFNetworking.h"
#import "RssService.h"
#import "showNoticesViewController.h"
#import "Configs.h"

const int vidaLoadingCellTag = 1273;

@interface UNLRSSVidaUniversitariaViewController ()
...
@implementation UNLRSSVidaUniversitariaViewController
...
- (void)fetchNotices{
    ...
    NSString *URLStringNoPage = VidaUniversitariaURL;
...
forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (cell.tag == vidaLoadingCellTag) {
        //pageNumber++
