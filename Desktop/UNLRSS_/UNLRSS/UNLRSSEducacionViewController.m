//
//  UNLRSSEducacionViewController.m
//  UNLRSS
//
...
#import "UNLRSSEducacionViewController.h"
#import "AFNetworking.h"
#import "RssService.h"
#import "showNoticesViewController.h"
#import "Configs.h"

const int educacionLoadingCellTag = 1273;

@interface UNLRSSEducacionViewController ()
...
@implementation UNLRSSEducacionViewController
...
- (void)fetchNotices{
    ...
    NSString *URLStringNoPage = EducacionURL;
...
- (UITableViewCell *)loadingCell
{
    ...
    cell.tag = educacionLoadingCellTag;
...
forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (cell.tag == educacionLoadingCellTag) {
        //pageNumber++
