...
#import "UNLRSSCulturaViewController.h"
#import "AFNetworking.h"
#import "RssService.h"
#import "showNoticesViewController.h"
#import "Configs.h"
const int culturaLoadingCellTag = 1273;

@interface UNLRSSCulturaViewController ()
...
@implementation UNLRSSCulturaViewController
...
- (void)fetchNotices{
    ...
    NSString *URLStringNoPage = CulturaURL;
...
- (UITableViewCell *)loadingCell
{
    ...
    cell.tag = culturaLoadingCellTag;
...
forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (cell.tag == culturaLoadingCellTag) {
        //pageNumber++
